...
@section('content')
    <div class="container">
        ...
        <div class="d-flex justify-content-center">
            <div class="card" style="border-radius: 10px;height: 400px; width: 400px;">
                <div class="card-body">
                    ...
                    >
                        ...
                        <div class="form-group d-flex align-items-center">
                            <label for="Sing in with" class="h5 my-1 mr-2">{{__('Sing in with:')}}</label>
        ...
        <div class="text-center" style="font-family: 'Calibri Light';">
            <div class="row">
                <div class="col-md-4 py-0 text-right">
                ...
                <div class="col-md-4 py-0 text-left">
                    <a class="btn btn-link font-weight-bold"href="">
                        {{ __('Help') }}
                    </a>
                </div>
